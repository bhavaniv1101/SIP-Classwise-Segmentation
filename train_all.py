...
def train_class(cls: str):
    ...
    dataset = SegDataset(training=True, transform=t,
                         img_names='C:/Users/bhava/Documents/SIP AAI-06/UNet_Aerial_Segmentation' + images,
                         mask_names=f'C:/Users/bhava/Documents/SIP AAI-06/UNet_Aerial_Segmentation/class_masks/{cls}')

    # dataset = ClasswiseSegDataset(root='C:/Users/bhava/Documents/SIP AAI-06/UNet_Aerial_Segmentation', split_idx=150)
...
if __name__ == '__main__':
    ...
    classes = ['Water', 'Building', 'Land', 'Road', 'Vegetation', 'Tree', 'Grass', 'Rocks', 'Window', 'Door',
               'Fence', 'Person', 'Car', 'Bicycle']
